 ...
 */
public class SysNestedScrollView extends FrameLayout implements NestedScrollingParent3,
    ...
    private static final int DEFAULT_MAX_OVERSCROLL_Y = 1000;
     ...
     *
     * @see #setOnScrollChangeListener(androidx.core.widget.NestedScrollView.OnScrollChangeListener)
     */
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(SysNestedScrollView v, int scrollX, int scrollY,
    ...
    private SysNestedScrollView.SavedState mSavedState;

    private static final SysNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new SysNestedScrollView.AccessibilityDelegate();
    ...
    private SysNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;

    public SysNestedScrollView(@NonNull Context context) {
        this(context, null);
    }

    public SysNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void stopNestedScroll(int type) {
        ...
        if (getScrollY() != 0 && mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
    ...
    private void onNestedScrollInternal(int dyUnconsumed, int type, @Nullable int[] consumed) {
        ...
        int dyRemain = dyUnconsumed - consumed[1];
        if (dyRemain != 0) {
            overScrollByCompat(0, dyRemain, 0, getScrollY(), 0, getScrollRange(), 0, DEFAULT_MAX_OVERSCROLL_Y, true);
        }
    }
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        final SysNestedScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        final int length = getVerticalFadingEdgeLength();
     ...
     */
    public void setOnScrollChangeListener(@Nullable SysNestedScrollView.OnScrollChangeListener l) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollByCompat(0, deltaY, 0, getScrollY(), 0, range, 0,
                            DEFAULT_MAX_OVERSCROLL_Y, true) && !hasNestedScrollingParent(ViewCompat.TYPE_TOUCH)) {
    ...
    int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            View child = getChildAt(0);
            SysNestedScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            int childSize = child.getHeight() + lp.topMargin + lp.bottomMargin;
            int parentSpace = getHeight() - getPaddingTop() - getPaddingBottom();
    ...
    public boolean pageScroll(int direction) {
        ...
        if (down) {
            ...
            if (count > 0) {
                ...
                SysNestedScrollView.LayoutParams lp = (LayoutParams) view.getLayoutParams();
    ...
    public void computeScroll() {
        ...
        if (unconsumed != 0) {
            // Internal Scroll
            final int oldScrollY = getScrollY();
            overScrollByCompat(0, unconsumed, getScrollX(), oldScrollY, 0, range, 0, DEFAULT_MAX_OVERSCROLL_Y, false);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof SysNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        SysNestedScrollView.SavedState ss = (SysNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        SysNestedScrollView.SavedState ss = new SysNestedScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<SysNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<SysNestedScrollView.SavedState>() {
                    @Override
                    public SysNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new SysNestedScrollView.SavedState(in);
                    }

                    @Override
                    public SysNestedScrollView.SavedState[] newArray(int size) {
                        return new SysNestedScrollView.SavedState[size];
                    }
                };
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final SysNestedScrollView nsvHost = (SysNestedScrollView) host;
