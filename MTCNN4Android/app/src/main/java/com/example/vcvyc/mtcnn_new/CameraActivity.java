...
import com.example.vcvyc.mtcnn_new.widget.FaceRectView;
...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    private Timer timer;
    private FaceRectView faceOverlayView;
    ...
    private void startDetect() {
        final MTCNN mtcnn = new MTCNN(getAssets());
        timer = new Timer();
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                if (mTextureView.isAvailable()) {
                    ...
                    bitmap = ImageUtils.compressByQuality(bitmap, 20);

                    Vector<Box> boxes = mtcnn.detectFaces(bitmap, 500);
//                    File sd = Environment.getExternalStorageDirectory();
//                    String file = sd + File.separator + System.currentTimeMillis() + ".jpg";
//                    ImageUtils.save(bitmap, file, Bitmap.CompressFormat.JPEG);
//                    bitmap.recycle();

                    ArrayList<Box> faces = new ArrayList<>();
                    faces.addAll(boxes);
//
                    for (int i = 0; i < boxes.size(); i++) {
//                        Bitmap bitmap2 = mTextureView.getBitmap(Bitmap.createBitmap(getResources().getDisplayMetrics(),
//                                mTextureView.getWidth(), mTextureView.getHeight(), Bitmap.Config.ARGB_8888));
                    ...
                    bitmap.recycle();
                    faceOverlayView.addFaceInfo(faces);
    ...
    private void initView() {
        faceOverlayView = (FaceRectView) findViewById(R.id.faceOverlayView);
        mTextureView = (TextureView) findViewById(R.id.textureView);
        bt_switch = (ImageButton) findViewById(R.id.bt_switch);
    ...
    private void switchCamera() {
        ...
        if (CameraCharacteristics.LENS_FACING_BACK == cameraId) {
            mCameraId = "0";
        } else {
            mCameraId = "1";
        }
