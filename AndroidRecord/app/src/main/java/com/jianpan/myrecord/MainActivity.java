...
public class MainActivity extends AppCompatActivity {
    ...
    //录音地址
    String filePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + "media.amr";
    //dialog显示的图片
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean granted = PermissionUtils.isGranted(Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        if (!granted) {
            PermissionUtils.permission(PermissionConstants.MICROPHONE, PermissionConstants.STORAGE)
                    ...
                    .callback(new PermissionUtils.SimpleCallback() {
                        ...
                        public void onGranted() {
                            ...
                            recordHintDialog = new RecordHintDialog(MainActivity.this, R.style.DialogStyle);
